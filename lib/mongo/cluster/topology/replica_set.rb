    ...
    module Topology
      ...
      class ReplicaSet
        ...
        def elect_primary(description, servers)
          if replica_set_name.nil? || description.replica_set_name == replica_set_name
            ...
            raise Mongo::Error::NoServerAvailable.new("Server #{description.address.to_s} in incorrect replica set: #{description.replica_set_name} (was configured with #{replica_set_name})")
          end
          self
        end
